...
SELECT
  ...
  -- Datos del sistema tomados directamente de v_resumen_turnos
  ...
  -- Conteos de platillos/bebidas desde v_resumen_turnos
...
-- Unir con v_resumen_turnos usando el mismo cierre_id
-- v_resumen_turnos.apertura_id = cierres.id (registros con fecha_apertura)
LEFT JOIN public.v_resumen_turnos vrt
